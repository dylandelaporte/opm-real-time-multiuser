...
var ScopeContainer = require('express-http-proxy/lib/scopeContainer');
var resolveProxyReqPath = require('express-http-proxy/app/steps/resolveProxyReqPath');
...
describe('resolveProxyReqPath', function () {
  ...
  describe('testing example code in docs', function () {
    it('works as advertised', function (done) {
      var proxyTarget = require('express-http-proxy/test/support/proxyTarget');
      var proxyRouteFn = [{
        method: 'get',
        path: '/tent',
        fn: function (req, res) {
