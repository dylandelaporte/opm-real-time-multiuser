...
`Napi::FunctionReference` is a subclass of [`Napi::Reference`](doc/reference.md), and
is equivalent to an instance of `Napi::Reference<Napi::Function>`. This means
that a `Napi::FunctionReference` holds a [`Napi::Function`](doc/function.md), and a
...
See the documentation for [`Napi::Function`](doc/function.md) for when `Call` should
...
class (for more info see: [`Napi::Reference`](doc/reference.md)).
...
This should normally be a value previously obtained from [Napi::AsyncContext](doc/async_context.md).
