...
- [`Napi::Value`](doc/value.md) and extends [`Napi::Array`](array.md)
- [`Napi::ArrayBuffer`](doc/array_buffer.md)
- [`Napi::Buffer<T>`](doc/buffer.md)
...
Returns the [`Napi::Value`](doc/value.md) associated with the key property. Returns the value *undefined* if the key does not exist.
...
```
- `[in] constructor`: The constructor [`Napi::Function`](doc/function.md) of the value that is being compared with the object.
...
```
- `[in] property`: A [`Napi::PropertyDescriptor`](doc/property_descriptor.md).
...
```
- `[in] properties`: A list of [`Napi::PropertyDescriptor`](doc/property_descriptor.md). Can be one of the following types:
...
Returns the named property as a [`Napi::Value`](doc/value.md).
...
Returns an indexed property or array element as a [`Napi::Value`](doc/value.md).
